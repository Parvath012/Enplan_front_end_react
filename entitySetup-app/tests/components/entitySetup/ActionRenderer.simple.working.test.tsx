...
const TestComponent = () => {
  ...
  return (
    <div data-testid="action-renderer">
      ...
      <div data-testid="tooltip-edit" title="Edit" placement="bottom">
        <button data-testid="enable-button" onClick={mockProps.onEnable}>Enable</button>
      </div>
      <div data-testid="tooltip-delete" title="Delete" placement="bottom">
        <button data-testid="disable-button" onClick={mockProps.onDisable}>Disable</button>
      </div>
      <div data-testid="tooltip-configure" title="Configure" placement="bottom">
...
describe('ActionRenderer - Simple Working Tests', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  it('should have proper tooltip structure', () => {
    ...
    tooltips.forEach(tooltip => {
      ...
      expect(tooltip).toHaveAttribute('placement');
    });
  });
