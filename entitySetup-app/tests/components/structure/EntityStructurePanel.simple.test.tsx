...
jest.mock('react', () => ({
  ...
  lazy: jest.fn((fn) => {
    return function MockLazyComponent(props: any) {
      return <div data-testid="test-lazy-component">Mock Lazy Component</div>;
    };
  }),
...
jest.mock('commonApp/FormHeader', () => {
  return function MockFormHeader(props: any) {
    return <div data-testid="form-header">Mock FormHeader</div>;
  };
});
...
const EntityStructurePanel = require('../../../src/components/structure/EntityStructurePanel').default;
