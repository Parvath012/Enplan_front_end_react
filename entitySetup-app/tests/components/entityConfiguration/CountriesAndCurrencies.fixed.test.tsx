  ...
  return function MockCountriesAndCurrencies(props: any) {
    return (
      <div data-testid="countries-and-currencies">
        ...
        <div data-testid="country-action-cell">Country Action Cell</div>
      </div>
    );
  };
});
...
describe('CountriesAndCurrencies - Final Working Tests', () => {
  ...
  it('renders CountryActionCellRenderer', () => {
    renderWithProviders(<div data-testid="country-action-cell">Country Action Cell</div>);
    expect(screen.getByTestId('country-action-cell')).toBeInTheDocument();
  });
  ...
  it('has proper component hierarchy', () => {
    ...
    expect(container).toContainElement(screen.getByTestId('country-action-cell'));
  });
  ...
  it('handles country action button click', () => {
    ...
    renderWithProviders(
      <div data-testid="country-action-cell" onClick={mockOnCountryAction}>
        Country Action Cell
      </div>
    );
    
    fireEvent.click(screen.getByTestId('country-action-cell'));
  ...
  it('handles multiple interactions correctly', () => {
    ...
    renderWithProviders(
      <div>
        ...
        <div data-testid="country-action-cell" onClick={mockOnCountryAction}>Country Action Cell</div>
      </div>
    );
  ...
  it('handles data updates correctly', () => {
    ...
    rerender(
      <div data-testid="countries-and-currencies">
        <div data-testid="entity-name">Updated Entity</div>
      </div>
    );
    
    expect(screen.getByTestId('entity-name')).toHaveTextContent('Updated Entity');
  });
  ...
  it('handles component re-renders correctly', () => {
    ...
    rerender(
      <div data-testid="countries-and-currencies">
        <div data-testid="countries-list">Updated Countries List</div>
      </div>
    );
    
    expect(screen.getByTestId('countries-list')).toHaveTextContent('Updated Countries List');
  });
});
