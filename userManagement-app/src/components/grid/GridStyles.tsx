...
const GridStyles: React.FC = () => (
  <style>{`
    ...
    /* Fix cell alignment - ensure all cells are vertically centered */
    ...
    /* Ensure consistent vertical alignment for all cell content */
    ...
    /* Fix for cells with custom classes */
    .ag-theme-alpine .ag-cell-custom {
      display: flex !important;
      align-items: center !important;
      padding-top: 0 !important;
      padding-bottom: 0 !important;
    ...
    /* Specific fix for Action column centering */
    .ag-theme-alpine .action-cell-no-border {
      display: flex !important;
      align-items: center !important;
    ...
    .ag-theme-alpine .action-cell-no-border .ag-cell-wrapper {
      display: flex !important;
      align-items: center !important;
      justify-content: center !important;
      width: 100% !important;
