...
import SharedIcon from '../../../src/components/userList/SharedIcon';

describe('SharedIcon', () => {
  describe('Component Rendering', () => {
    it('should render without crashing', () => {
      const { container } = render(<SharedIcon />);
  ...
  describe('Custom Size', () => {
    it('should render with custom size of 20', () => {
      const { container } = render(<SharedIcon size={20} />);
    ...
    it('should render with custom size of 24', () => {
      const { container } = render(<SharedIcon size={24} />);
    ...
    it('should render with custom size of 32', () => {
      const { container } = render(<SharedIcon size={32} />);
    ...
    it('should render with very small size', () => {
      const { container } = render(<SharedIcon size={8} />);
    ...
    it('should render with very large size', () => {
      const { container } = render(<SharedIcon size={64} />);
  ...
  describe('Custom Color', () => {
    it('should render with custom color #FF0000', () => {
      const { container } = render(<SharedIcon color="#FF0000" />);
    ...
    it('should render with custom color #00FF00', () => {
      const { container } = render(<SharedIcon color="#00FF00" />);
    ...
    it('should render with custom color #0000FF', () => {
      const { container } = render(<SharedIcon color="#0000FF" />);
    ...
    it('should render with rgb color', () => {
      const { container } = render(<SharedIcon color="rgb(255, 0, 0)" />);
    ...
    it('should render with rgba color', () => {
      const { container } = render(<SharedIcon color="rgba(255, 0, 0, 0.5)" />);
    ...
    it('should render with named color', () => {
      const { container } = render(<SharedIcon color="red" />);
  ...
  describe('Custom Size and Color', () => {
    it('should render with both custom size and color', () => {
      const { container } = render(
        <SharedIcon size={24} color="#FF5733" />
      );
    ...
    it('should render with size 32 and custom color', () => {
      const { container } = render(
        <SharedIcon size={32} color="#00AA00" />
      );
  ...
  describe('SVG Structure', () => {
    it('should contain 6 path elements', () => {
      const { container } = render(<SharedIcon />);
    ...
    it('should have correct path d attributes', () => {
      ...
      expect(paths[5]).toHaveAttribute('d', 'M27,9v1h2v-1c0-3.9-3.1-7-7-7h-3v2h3c2.8,0,5,2.2,5,5Z');
    });
  });

  describe('Edge Cases', () => {
    it('should handle size of 0', () => {
      const { container } = render(<SharedIcon size={0} />);
    ...
    it('should handle negative size (renders as is)', () => {
      const { container } = render(<SharedIcon size={-10} />);
    ...
    it('should handle empty string color', () => {
      const { container } = render(<SharedIcon color="" />);
    ...
    it('should handle decimal size', () => {
      const { container } = render(<SharedIcon size={16.5} />);
  ...
  describe('Accessibility', () => {
    ...
    it('should maintain aspect ratio with viewBox', () => {
      const { container } = render(<SharedIcon size={48} />);
  ...
  describe('Multiple Instances', () => {
    it('should render multiple instances with different props', () => {
      const { container } = render(
        <div>
          <SharedIcon size={16} color="#FF0000" />
          <SharedIcon size={24} color="#00FF00" />
          <SharedIcon size={32} color="#0000FF" />
        </div>
      );
  ...
  describe('Visual Representation', () => {
    it('should represent a shared/transferred user icon', () => {
      const { container } = render(<SharedIcon />);
      
      // The icon should have paths representing user figures and transfer arrows
      const paths = container.querySelectorAll('path');
      expect(paths.length).toBeGreaterThan(0);
    });

    it('should have consistent structure across renders', () => {
      const { container: container1 } = render(<SharedIcon />);
      const { container: container2 } = render(<SharedIcon />);
  ...
  describe('Comparison with CustomTransferIcon', () => {
    it('should have more paths than CustomTransferIcon (6 vs 5)', () => {
      const { container } = render(<SharedIcon />);
    ...
    it('should not have polygon element unlike CustomTransferIcon', () => {
      const { container } = render(<SharedIcon />);
    ...
    it('should have different visual representation', () => {
      const { container } = render(<SharedIcon />);
      
      // SharedIcon has 6 paths (no X mark), CustomTransferIcon has 5 paths + 1 polygon (X mark)
      const paths = container.querySelectorAll('path');
      const polygon = container.querySelector('polygon');
